...
<div class="app-container  container-fluid d-flex align-items-stretch justify-content-between "
    ...
    <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
        <a href="" class="d-lg-none">
            <img alt="Logo"
                 src="{{ isset($siteData->logo) ? asset($siteData->logo) : asset('/assets/media/logos/default-small.svg') }}"
                 class="h-30px"/>
        </a>
    </div>
    <!--end::Mobile logo-->
    ...
    <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1"
        ...
        <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true"
            ...
            <div
                ...
                {{--                                                    class="bullet bullet-dot"></span></span><span class="menu-title">View Project</span></a>--}}
                {{--                                        <!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item-->--}}
                {{--                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"--}}
                {{--                                                                                    href=""><span--}}
                {{--                                                class="menu-bullet"><span--}}
                {{--                                                    class="bullet bullet-dot"></span></span><span class="menu-title">Targets</span></a>--}}
                {{--                                        <!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item-->--}}
                {{--                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"--}}
                {{--                                                                                    href=""><span--}}
                {{--                                                class="menu-bullet"><span--}}
                {{--                                                    class="bullet bullet-dot"></span></span><span class="menu-title">Budget</span></a>--}}
                {{--                                        <!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item-->--}}
                {{--                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"--}}
                {{--                                                                                    href=""><span--}}
                {{--                                                class="menu-bullet"><span--}}
                ...
                {{--                                                                                    href=""><span--}}
                {{--                                                class="menu-bullet"><span--}}
                {{--                                                    class="bullet bullet-dot"></span></span><span class="menu-title">Files</span></a>--}}
                {{--                                        <!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item-->--}}
                {{--                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"--}}
                {{--                                                                                    href=""><span--}}
                {{--                                                class="menu-bullet"><span--}}
                {{--                                                    class="bullet bullet-dot"></span></span><span class="menu-title">Activity</span></a>--}}
                {{--                                        <!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item-->--}}
                {{--                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"--}}
                {{--                                                                                    href=""><span--}}
                {{--                                                class="menu-bullet"><span--}}
                ...
                {{--                                 data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">--}}
                {{--                                <!--begin:Menu link--><span class="menu-link"><span class="menu-icon"><i--}}
                {{--                                            class="ki-duotone ki-handcart fs-2"></i></span><span class="menu-title">eCommerce</span><span--}}
                ...
                {{--                                                        class="menu-bullet"><span--}}
                {{--                                                            class="bullet bullet-dot"></span></span><span--}}
                {{--                                                        class="menu-title">View Roles</span></a><!--end:Menu link-->--}}
                {{--                                            </div><!--end:Menu item--></div><!--end:Menu sub--></div>--}}
                {{--                                    <!--end:Menu item--><!--begin:Menu item-->--}}
                {{--                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"--}}
                {{--                                                                                    href=""><span--}}
                ...
                {{--                                                                                    href=""><span--}}
                {{--                                                class="menu-bullet"><span--}}
                {{--                                                    class="bullet bullet-dot"></span></span><span class="menu-title">Add Contact</span></a>--}}
                {{--                                        <!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item-->--}}
                {{--                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"--}}
                {{--                                                                                    href=""><span--}}
                {{--                                                class="menu-bullet"><span--}}
                {{--                                                    class="bullet bullet-dot"></span></span><span class="menu-title">Edit Contact</span></a>--}}
                {{--                                        <!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item-->--}}
                {{--                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"--}}
                {{--                                                                                    href=""><span--}}
                {{--                                                class="menu-bullet"><span--}}
                {{--                                                    class="bullet bullet-dot"></span></span><span class="menu-title">View Contact</span></a>--}}
                {{--                                        <!--end:Menu link--></div><!--end:Menu item--></div><!--end:Menu sub-->--}}
                {{--                            </div><!--end:Menu item--><!--begin:Menu item-->--}}
                {{--                            <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"--}}
                {{--                                 data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">--}}
                ...
                {{--                                                                                    href=""><span--}}
                {{--                                                class="menu-bullet"><span--}}
                {{--                                                    class="bullet bullet-dot"></span></span><span class="menu-title">Subscription List</span></a>--}}
                {{--                                        <!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item-->--}}
                {{--                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"--}}
                {{--                                                                                    href=""><span--}}
                {{--                                                class="menu-bullet"><span--}}
                {{--                                                    class="bullet bullet-dot"></span></span><span class="menu-title">Add Subscription</span></a>--}}
                {{--                                        <!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item-->--}}
                {{--                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link"--}}
                {{--                                                                                    href=""><span--}}
                {{--                                                class="menu-bullet"><span--}}
                {{--                                                    class="bullet bullet-dot"></span></span><span class="menu-title">View Subscription</span></a>--}}
                {{--                                        <!--end:Menu link--></div><!--end:Menu item--></div><!--end:Menu sub-->--}}
                {{--                            </div><!--end:Menu item--><!--begin:Menu item-->--}}
                {{--                            <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"--}}
                {{--                                 data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">--}}
                ...
                {{--                                    class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">--}}
                {{--                                    <!--begin:Menu item-->--}}
                {{--                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link menu-bullet"><span--}}
                {{--                                                class="bullet bullet-dot"></span><span class="menu-title">Getting Started</span></a>--}}
                {{--                                        <!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item-->--}}
                {{--                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link" href=""><span--}}
                {{--                                                class="menu-bullet"><span--}}
                {{--                                                    class="bullet bullet-dot"></span></span><span class="menu-title">Customer Listing</span></a>--}}
                {{--                                        <!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item-->--}}
                {{--                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link" href=""><span--}}
                {{--                                                class="menu-bullet"><span--}}
                {{--                                                    class="bullet bullet-dot"></span></span><span class="menu-title">Customer Details</span></a>--}}
                {{--                                        <!--end:Menu link--></div><!--end:Menu item--></div><!--end:Menu sub-->--}}
                {{--                            </div><!--end:Menu item--><!--begin:Menu item-->--}}
                {{--                            <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"--}}
                {{--                                 data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">--}}
                ...
                {{--                                         class="menu-item menu-lg-down-accordion"><!--begin:Menu link--><span--}}
                {{--                                            class="menu-link"><span class="menu-bullet"><span--}}
                {{--                                                    class="bullet bullet-dot"></span></span><span class="menu-title">Profile</span><span--}}
                {{--                                                class="menu-arrow"></span></span><!--end:Menu link-->--}}
                {{--                                        <!--begin:Menu sub-->--}}
                {{--                                        <div--}}
                {{--                                            class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">--}}
                ...
                {{--                                                                                    href=""><span--}}
                {{--                                                class="menu-bullet"><span--}}
                {{--                                                    class="bullet bullet-dot"></span></span><span class="menu-title">Create Invoice</span></a>--}}
                {{--                                        <!--end:Menu link--></div><!--end:Menu item--></div><!--end:Menu sub-->--}}
                {{--                            </div><!--end:Menu item--><!--begin:Menu item-->--}}
                {{--                            <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"--}}
                {{--                                 data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">--}}
                ...
                {{--                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link" href=""><span--}}
                {{--                                                class="menu-bullet"><span--}}
                {{--                                                    class="bullet bullet-dot"></span></span><span class="menu-title">Folders</span></a>--}}
                {{--                                        <!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item-->--}}
                {{--                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link" href=""><span--}}
                {{--                                                class="menu-bullet"><span--}}
                {{--                                                    class="bullet bullet-dot"></span></span><span class="menu-title">Files</span></a>--}}
                ...
                {{--                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link" href=""><span--}}
                {{--                                                class="menu-bullet"><span--}}
                {{--                                                    class="bullet bullet-dot"></span></span><span class="menu-title">Blank Directory</span></a>--}}
                {{--                                        <!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item-->--}}
                {{--                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link" href=""><span--}}
                {{--                                                class="menu-bullet"><span--}}
                {{--                                                    class="bullet bullet-dot"></span></span><span class="menu-title">Settings</span></a>--}}
                ...
                {{--                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link" href=""><span--}}
                {{--                                                class="menu-bullet"><span--}}
                {{--                                                    class="bullet bullet-dot"></span></span><span class="menu-title">Messages</span><span--}}
                {{--                                                class="menu-badge"><span--}}
                {{--                                                    class="badge badge-light-success">3</span></span></a>--}}
                {{--                                        <!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item-->--}}
                {{--                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link" href=""><span--}}
                {{--                                                class="menu-bullet"><span--}}
                {{--                                                    class="bullet bullet-dot"></span></span><span class="menu-title">Compose</span></a>--}}
                {{--                                        <!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item-->--}}
                {{--                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link" href=""><span--}}
                {{--                                                class="menu-bullet"><span--}}
                {{--                                                    class="bullet bullet-dot"></span></span><span class="menu-title">View & Reply</span></a>--}}
                {{--                                        <!--end:Menu link--></div><!--end:Menu item--></div><!--end:Menu sub-->--}}
                {{--                            </div><!--end:Menu item--><!--begin:Menu item-->--}}
                {{--                            <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"--}}
                {{--                                 data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">--}}
                ...
                {{--                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link" href=""><span--}}
                {{--                                                class="menu-bullet"><span--}}
                {{--                                                    class="bullet bullet-dot"></span></span><span class="menu-title">Private Chat</span></a>--}}
                {{--                                        <!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item-->--}}
                {{--                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link" href=""><span--}}
                {{--                                                class="menu-bullet"><span--}}
                {{--                                                    class="bullet bullet-dot"></span></span><span class="menu-title">Group Chat</span></a>--}}
                {{--                                        <!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item-->--}}
                {{--                                    <div class="menu-item"><!--begin:Menu link--><a class="menu-link" href=""><span--}}
                {{--                                                class="menu-bullet"><span--}}
                {{--                                                    class="bullet bullet-dot"></span></span><span class="menu-title">Drawer Chat</span></a>--}}
                {{--                                        <!--end:Menu link--></div><!--end:Menu item--></div><!--end:Menu sub-->--}}
                {{--                            </div><!--end:Menu item--><!--begin:Menu item-->--}}
                {{--                            <div class="menu-item"><!--begin:Menu link--><a class="menu-link" href=""><span--}}
                    ...
                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown p-0 w-100 w-lg-850px">
                        <div class="menu-active-bg pt-1 pb-3 px-3 py-lg-6 px-lg-6" data-kt-menu-dismiss="true">
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    <div class="row mt-3">
                                        @php $servs = \App\Models\Service::latest()->where('status', 1)->get(); @endphp
                                            <!--begin:Menu item-->
                                        @foreach($servs as $serv)
                                            ...
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span>
                                                        ...
                                                        <span class="menu-title">{{ $serv->name }}</span>
                                                    </a>
                                                </div>
                                            </div>
                                        @endforeach
                ...
                <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"
                     class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
                    <a href="{{ route('catch.clear') }}">
                        <span class="menu-link fs-6">
                            <span class="menu-title">{{ env('app_debug') ? 'Catch clear' : 'Refresh' }}</span>
                            <span class="menu-arrow d-lg-none"></span>
                        </span>
                    </a>
                </div>
        ...
        <div class="app-navbar flex-shrink-0">
            ...
            <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                ...
                <div
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content d-flex align-items-center px-3">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <a href="#"
                                   class="fw-semibold text-muted text-hover-primary fs-7">{{ Auth::check() ? Auth::user()->email : 'default@gmail.com'}}</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="menu-item px-5">
                        <a href="#" class="menu-link px-5" onclick="logout()">Sign Out</a>
